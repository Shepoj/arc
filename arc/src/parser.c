...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_PROGRAMME = 17,                 /* PROGRAMME  */
  YYSYMBOL_EXP = 18                        /* EXP  */
};
...
yysymbol_name (yysymbol_kind_t yysymbol)
{
  ...
  {
  "end of file", "error", "invalid token", "NB", "ID", "MAIN", "DEBUT",
  "FIN", "'+'", "'-'", "'*'", "'/'", "'%'", "'('", "')'", "';'", "$accept",
  "PROGRAMME", "EXP", YY_NULLPTR
  };
...
{
       2,    14,    21,    12,    -7,    22,    -3,    -7,    -7,    -3,
      -6,     8,    -3,    -3,    -3,    -3,    -3,    23,    -7,    13,
      13,    -7,    -7,    -7,    -7
};
...
{
       7,     8,    12,    13,    14,    15,    16,     1,    11,    17,
       9,    19,    20,    21,    22,    23,    12,    13,    14,    15,
      16,     4,    18,    14,    15,    16,     5,     3,     6,     0,
      24
};

static const yytype_int8 yycheck[] =
{
       3,     4,     8,     9,    10,    11,    12,     5,     9,    15,
      13,    12,    13,    14,    15,    16,     8,     9,    10,    11,
      12,     0,    14,    10,    11,    12,    14,    13,     6,    -1,
       7
};
...
{
       0,     5,    17,    13,     0,    14,     6,     3,     4,    13,
      18,    18,     8,     9,    10,    11,    12,    15,    14,    18,
      18,    18,    18,    18,     7
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* PROGRAMME: MAIN '(' ')' DEBUT EXP ';' FIN  */
#line 46 "src/parser.y"
                                {ARBRE_ABSTRAIT=(yyvsp[-2].arbre);PrintAst(ARBRE_ABSTRAIT);}
